...
# Define the API Key.
API_KEY = 'AIzaSyD-zWRdiOmNswq-0TETR3a56aONSJxsbnY'
...
places_result  = gmaps.places_nearby(location='36.603954, -121.898460', radius = 40000, open_now =False , type = 'Italian')
